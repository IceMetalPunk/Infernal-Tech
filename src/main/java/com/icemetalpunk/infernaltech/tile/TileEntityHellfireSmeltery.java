...
public class TileEntityHellfireSmeltery extends TileEntityLockable implements ITickable, ISidedInventory {
	 ...
	 */
	protected NonNullList<ItemStack> furnaceItemStacks = NonNullList.<ItemStack> withSize(3, ItemStack.EMPTY);
	...
	public void update() {
		...
		if (!this.world.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				BlockHellfireSmeltery.setState(this.isBurning(), this.world, this.pos);
			}
		}
